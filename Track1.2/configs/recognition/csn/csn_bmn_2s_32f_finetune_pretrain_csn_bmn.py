...
data_root = '/home/notebook/data/personal/dataset/loveu/loveu_wide_trainvals_2s_30fps' #'/home/notebook/data/group/zhangchen/action_dataset/kinetics-gebd/trainset' 
data_root_val = '/home/notebook/data/personal/dataset/loveu/loveu_wide_val_2s_30fps' #'/home/notebook/data/group/zhangchen/action_dataset/kinetics-gebd/valset'
...
train_pipeline = [
    ...
    dict(type='GEBD_Loading', window_size=32, len_clip_second = 2, sample_rate = 30, temporal_flip=True,thres=0.5),
...
test_pipeline = [
    ...
    dict(
        ...
        meta_name='video_meta',
        meta_keys=[
            'video_name', 'duration_second', 'duration_frame',
        ]),
...
optimizer = dict(
    type='SGD', lr=0.00006, momentum=0.9,
    weight_decay=0.0001)
...
load_from =  None #'/home/notebook/data/personal/mmaction2/data/output/csn_pretrain_2s_32f_keeptem_pretrain/epoch_14.pth' #'/home/notebook/data/personal/mmaction2/data/output/csn_bmn_4cls_2s_32f_bw_16f_bmn_atten_wo_extra_featrues/epoch_9.pth'
resume_from = 'data/output/csn_bmn_4cls_2s_32f_bw_16f_bmn_atten_wo_extra_feature_finetune_bmn_cls_csn_pretrain/epoch_4.pth' #'/home/notebook/data/personal/loveu/mmaction2/work_dirs/loveu_4cls_1500ms_csn/epoch_20.pth'
workflow = [('train', 1)]
