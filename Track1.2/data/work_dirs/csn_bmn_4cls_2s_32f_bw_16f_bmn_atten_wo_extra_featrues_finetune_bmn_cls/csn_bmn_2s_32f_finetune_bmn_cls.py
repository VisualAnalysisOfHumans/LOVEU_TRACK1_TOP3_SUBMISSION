...
log_level = 'INFO'
work_dir = '/home/notebook/data/personal/mmaction2/data/output/csn_bmn_4cls_2s_32f_bw_16f_bmn_atten_wo_extra_featrues_finetune_bmn_cls'
load_from = None
resume_from = 'data/output/csn_bmn_4cls_2s_32f_bw_16f_bmn_atten_wo_extra_featrues_finetune_bmn_cls/epoch_4.pth'
workflow = [('train', 1)]
