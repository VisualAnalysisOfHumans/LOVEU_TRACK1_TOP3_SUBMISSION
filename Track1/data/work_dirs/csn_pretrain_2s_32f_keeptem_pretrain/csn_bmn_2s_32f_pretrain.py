...
data_root = '/home/notebook/data/group/chenen.cc/code/loveu/data/loveu_wide_train_2s_30fps'
data_root_val = '/home/notebook/data/group/chenen.cc/code/loveu/data/loveu_wide_val_2s_30fps'
...
data = dict(
    ...
    train=dict(
        type='GEBDataset',
        ann_file=
        '/home/notebook/data/group/chenen.cc/code/loveu/data/loveu_wide_train_2s_30fps_annotation_valid.txt',
        data_prefix=
        '/home/notebook/data/group/chenen.cc/code/loveu/data/loveu_wide_train_2s_30fps',
        pipeline=[
            dict(type='DecordInit'),
            dict(
                type='SampleFrames',
    ...
    val=dict(
        type='GEBDataset',
        ann_file=
        '/home/notebook/data/group/chenen.cc/code/loveu/data/loveu_wide_val_2s_30fps_annotation_valid.txt',
        data_prefix=
        '/home/notebook/data/group/chenen.cc/code/loveu/data/loveu_wide_val_2s_30fps',
        pipeline=[
            dict(type='DecordInit'),
            dict(
                type='SampleFrames',
...
log_level = 'INFO'
work_dir = '/home/notebook/data/personal/mmaction2/data/output/csn_pretrain_2s_32f_keeptem_pretrain/'
load_from = None
resume_from = None
workflow = [('train', 1)]
