...
data = dict(
    ...
    train=dict(
        type='VideoDataset',
        ann_file=
        '/home/notebook/data/personal/loveu/data/loveu_wide_2cls_train_annotation_valid.txt',
        data_prefix='',
        pipeline=[
            dict(type='DecordInit'),
            dict(
    ...
    val=dict(
        type='VideoDataset',
        ann_file=
        '/home/notebook/data/personal/loveu/data/loveu_wide_2cls_val_annotation_valid.txt',
        data_prefix='',
        pipeline=[
            dict(type='DecordInit'),
            dict(
...
log_level = 'INFO'
work_dir = 'work_dirs/loveu_2cls_1500ms_csn'
load_from = None
