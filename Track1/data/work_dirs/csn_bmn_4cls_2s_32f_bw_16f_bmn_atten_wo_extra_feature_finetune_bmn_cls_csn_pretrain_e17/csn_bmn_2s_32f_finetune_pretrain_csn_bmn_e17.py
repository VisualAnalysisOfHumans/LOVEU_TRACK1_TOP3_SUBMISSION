...
log_level = 'INFO'
work_dir = '/home/notebook/data/personal/mmaction2/data/output/csn_bmn_4cls_2s_32f_bw_16f_bmn_atten_wo_extra_feature_finetune_bmn_cls_csn_pretrain_e17'
load_from = '/home/notebook/data/personal/mmaction2/data/output/csn_pretrain_2s_32f_keeptem_pretrain/epoch_17.pth'
resume_from = None
workflow = [('train', 1)]
